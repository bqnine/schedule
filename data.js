...
let schedule = [' 8AM', ' OFF', ' OFF', '  8P', '  8P', '  8P', ' OFF', ' OFF', ' 8AM', ' 8AM', ' 8AM', ' OFF', ' OFF', ' 8PM', ' 8PM', ' 8PM', ' 8PM', ' OFF', ' OFF', ' OFF', ' OFF', ' OFF', ' 8-4', ' 8-4', ' 8-4', ' 8-4', ' OFF', ' OFF', ' OFF', ' OFF', ' OFF', ' OFF', ' 8AM', ' 8AM', ' 8AM'];
...
function setArrays(year,group,boro,shift) {
    ...
    // Changes the array rotationSchedule depending on the boro and shift selected
...
schedule =  rotationSchedule[0].concat(rotationSchedule[1],rotationSchedule[2],rotationSchedule[3],rotationSchedule[4]); 
